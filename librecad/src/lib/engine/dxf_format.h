...
/**
 * Classes containing constants and functions relating to the DXF file format.
...
//	~DXF_Format();
	...
	static inline const int GC_Comment = 999;				/* Each comment starts with 999 followed by a line of arbitrary comment text */

	/*	Sections of the DXF file  */
	static inline const int GC_Section = 0;					/* Each section starts with 0 followed by keyword SECTION */
	static inline const std::string Section_Keyword= "SECTION";					/* Section keyword */

	static inline const int GC_SectionName = 2;				/* Name of section is given by 2 followed by the section namestring */
	static inline const std::string SectionName_Header = "HEADER";				/* Header section name string */
	static inline const std::string SectionName_Classes = "CLASSES";			/* Classes section name string */
	static inline const std::string SectionName_Tables = "TABLES";				/* Tables section name string */
	static inline const std::string SectionName_Blocks = "BLOCKS";				/* Blocks section name string */
	static inline const std::string SectionName_Entities = "ENTITIES";			/* Entities section name string */
	static inline const std::string SectionName_Objects = "OBJECTS";			/* Objects section name string */
	static inline const std::string SectionName_Thumbnailimage = "THUMBNAILIMAGE";		/* Thumbnailimage section name string */

	static inline const int GC_EndSec = 0;					/* Each section ends with 0 followed by keyword ENDSEC */
	static inline const std::string EndSec_Keyword= "ENDSEC";					/* End of section keyword */
	...
	*/
	...
	static inline const int GC_VarName = 9;

	/* Maintenance version number (should be ignored) - 9, $ACADMAINTVER, 70, <integer> */
	static inline const int GC_AcadMaintVer = 70;

	/* AutoCAD drawing database version number - 9, $ACADVER, 1, <string> */
	static inline const int GC_AcadVer = 1;
	static inline const std::string Ver_Acad2000 = "AC1015";		/* $ACADVER value string, AutoCAD 2000 */ 
	static inline const std::string Ver_Acad2004 = "AC1018";		/* $ACADVER value string, AutoCAD 2004 */ 
	static inline const std::string Ver_Acad2007 = "AC1021";		/* $ACADVER value string, AutoCAD 2007 */ 
	static inline const std::string Ver_Acad2010 = "AC1024";		/* $ACADVER value string, AutoCAD 2010 */ 

	/* Angle 0 direction - 9, $ANGBASE, 50, <angle 0 direction, double> */
	static inline const int GC_AngBase = 50;

	/* Attribute visibility - 9, $ATTMODE, 70, <integer> */
	static inline const int GC_AttMode = 70;
	//0 = None, 1 = Normal, 2 = All

	/* Units format for angles - 9, $AUNITS, 70, <integer> */
	static inline const int GC_AUnits = 70;

	/* Units precision for angles - 9, $AUPREC, 70, <integer> */
	static inline const int GC_AUPrec = 70;

	/* Current entity color number - 9, $CECOLOR, 62, <integer> */
	static inline const int GC_CEColor = 62;
	//0 = BYBLOCK
	//1 - 255 = colour number
	//256 = BYLAYER

	/* Current entity linetype scale - 9, $CELTSCALE, 40, <double> */
	static inline const int GC_CELTScale = 40;

	/* Entity linetype name, or BYBLOCK or BYLAYER - 9, $CELTYPE, 6, <string> */
	static inline const int GC_CELType = 6;

	/* Lineweight of new objects - 9, $CELWEIGHT, 370, <integer> */
	static inline const int GC_CELWeight = 370;

	/* Plotstyle handle of new objects; if CEPSNTYPE is 3, then this value indicates the handle
	   - 9, $CEPSNID, 390, <string> */
	static inline const int GC_CEPSNID = 390;

	/* Plot style type of new objects - 9, $CEPSNTYPE, 380, <integer> */
	static inline const int GC_CEPSNType = 380;
	...
	static inline const int GC_DimAltU = 70;
	//1 = Scientific
	//2 = Decimal
	//3 = Engineering
	...
	static inline const int GC_DimAltZ = 70;
	//0 = Suppresses zero feet and precisely zero inches
	//1 = Includes zero feet and precisely zero inches
	//2 = Includes zero feet and suppresses zero inches
	//3 = Includes zero inches and suppresses zero feet
	...
	static inline const int GC_DimAssoc = 280;
	...
	static inline const int GC_DimASz = 40;
	...
	static inline const int GC_DimATFit = 70;
	...
	static inline const int GC_DimAUnit = 70;
	//0 = Decimal degrees
	...
	static inline const int GC_DimAZIn = 70;
	...
	/* Scale factor used to calculate the height of text for dimension fractions and tolerances. 
	   ...
	   - 9, $DIMFAC, 40, <double> */
	static inline const int GC_DimFac = 40;

	/* Dimension line gap - 9, $DIMGAP, 40, <double> */
	static inline const int GC_DimGap = 40;

	/* Horizontal dimension text position - 9, $DIMJUST, 70, <integer> */
	static inline const int GC_DimJust = 70;
	...
	static inline const int GC_DimLWD = 70;
	//-3 = Standard
	//-2 = ByLayer
	//-1 = ByBlock
	...
	static inline const int GC_DimLWE = 70;
	//-3 = Standard
	//-2 = ByLayer
	//-1 = ByBlock
	//0-211 = an integer representing 100th of mm
	...
	static inline const int GC_DimUPT = 70;
	...
	static inline const int GC_DimZIn = 70;
	//0 = Suppresses zero feet and precisely zero inches
	//1 = Includes zero feet and precisely zero inches
	//2 = Includes zero feet and suppresses zero inches
	//3 = Includes zero inches and suppresses zero feet
	...
	static inline const int GC_DispSilh = 70;
	//0 = Off
	//1 = On
	...
	static inline const int GC_DragVS = 349;
	...
	static inline const int GC_ExtMax_X = 10;
	static inline const int GC_ExtMax_Y = 20;
	static inline const int GC_ExtMax_Z = 30;

	/* Drawing extents lower-left corner (in WCS) - 9, $EXTMIN, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_ExtMin_X = 10;
	static inline const int GC_ExtMin_Y = 20;
	static inline const int GC_ExtMin_Z = 30;

	/* Controls symbol table naming - 9, $EXTNAMES, 290, <boolean> */
	static inline const int GC_ExtNames = 290;
	...
	static inline const int GC_HaloGap = 280;

	/* Next available handle - 9, $HANDSEED, 5, <hex digit string> */
	static inline const int GCHandSeed = 5;

	/* Specifies HIDETEXT system variable - 9, $HIDETEXT, 290, <boolean> */
	static inline const int GC_HideText = 290;
	...
	static inline const int GC_InsBase_X = 10;
	static inline const int GC_InsBase_Y = 20;
	static inline const int GC_InsBase_Z = 30;

	/* Default drawing units for AutoCAD DesignCenter blocks - 9, $INSUNITS, 70, <integer> */
	static inline const int GC_InsUnits = 70;
	//0 = Unitless
	//1 = Inches
	//2 = Feet
	//3 = Miles
	...
	static inline const int GC_InterfereColor = 62;
	...
	static inline const int GC_InterfereObjVS = 345;
	...
	static inline const int GC_InterfereVPVS = 346;

	/* Specifies the entity color of intersection polylines - 9, $INTERSECTIONCOLOR, 70, <integer> */
	static inline const int GC_IntersectionColor = 70;
	...
	static inline const int GC_IntersectionDisplay = 290;
	...
	static inline const int GC_JoinStyle = 280;
	//0=None
	//1= Round
	//2 = Angle
	//3 = Flat
	...
	static inline const int GC_Limcheck = 70;

	/* XY drawing limits upper-right corner (in WCS) - 9, $LIMMAX, 10, <double X>, 20, <double Y> */
	static inline const int GC_LimMax_X = 10;
	static inline const int GC_LimMax_Y = 20;

	/* XY drawing limits lower-left corner (in WCS) - 9, $LIMMIN, 10, <double X>, 20, <double Y> */
	static inline const int GC_LimMin_X = 10;
	static inline const int GC_LimMin_Y = 20;

	/* Global linetype scale - 9, $LTSCALE, 40, <double> */
	static inline const int GC_LTScale = 40;

	/* Units format for coordinates and distances - 9, $LUNITS, 70, <integer> */
	static inline const int GC_LUnits = 70;
	...
	static inline const int GC_MaxActVP = 70;

	/* Sets drawing units - 9, $MEASUREMENT, 70, <integer> */
	static inline const int GC_Measurement = 70;
	//0 = English
	//1 = Metric

	/* Name of menu file - 9, $MENU, 1, <string> */
	static inline const int GC_Menu = 1;

	/* Mirror text if nonzero - 9, $MIRRTEXT, 70, <integer> */
	static inline const int GC_MirrText = 70;
	...
	static inline const int GC_ObsColor = 70;
	...
	static inline const int GC_ObsLType = 280;
	//0 = Off
	//1 = Solid
	//2 = Dashed
	//3 = Dotted
	...
	static inline const int GC_OrthoMode = 70;
	...
	/* Point display mode - 9, $PDMODE, 70, <integer>
	   ...
	   or square or both.                                                                   */
	static inline const int GC_PDMode = 70;
	static inline const int PDMode_CentreDot = 0;		/* . to mark centre of point */
	static inline const int PDMode_CentreBlank = 1;		/* no centre mark for point */
	static inline const int PDMode_CentrePlus = 2;		/* + to mark centre of point */
	static inline const int PDMode_CentreCross = 3;		/* X to mark centre of point */
	static inline const int PDMode_CentreTick = 4;		/* ' to mark centre of point */

	static inline constexpr int PDMode_EncloseCircle(int centre){return (centre|32);}
	static inline constexpr int PDMode_EncloseSquare(int centre){return (centre|64);}
	static inline constexpr int PDMode_EncloseCircleSquare(int centre){return (centre|96);}

	static inline constexpr int PDMode_getCentre(int mode){return (mode&7);}
	static inline constexpr int PDMode_hasEncloseCircle(int mode){return (mode&32);}
	static inline constexpr int PDMode_hasEncloseSquare(int mode){return (mode&64);}
	...
	static inline const int GC_PDSize = 40;

	static inline constexpr double PDSize_Absolute(double size){return (size);}
	static inline constexpr double PDSize_Percent(double size){return (- size);}

	static inline constexpr int PDSize_isAbsolute(double size){return (size>=0);}
	static inline constexpr int PDSize_isPercent(double size){return (size<0);}

	/* Current paper space elevation - 9, $PELEVATION, 40, <double> */
	static inline const int GC_PElevation = 40;

	/* Maximum extents for paper space - 9, $PEXTMAX, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_PExtMax_X = 10;
	static inline const int GC_PExtMax_Y = 20;
	static inline const int GC_PExtMax_Z = 30;

	/* Minimum extents for paper space - 9, $PEXTMIN, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_PExtMin_X = 10;
	static inline const int GC_PExtMin_Y = 20;
	static inline const int GC_PExtMin_Z = 30;

	/* Paper space insertion base point - 9, $PINSBASE, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_PInsBase_X = 10;
	static inline const int GC_PInsBase_Y = 20;
	static inline const int GC_PInsBase_Z = 30;

	/* Limits checking in paper space when nonzero - 9, $PLIMCHECK, 70, <integer> */
	static inline const int GC_PLimCheck = 70;

	/* Maximum X and Y limits in paper space - 9, $PLIMMAX, 10, <double X>, 20, <double Y> */
	static inline const int GC_PLimMax_X = 10;
	static inline const int GC_PLimMax_Y = 20;

	/* Minimum X and Y limits in paper space - 9, $PLIMMIN, 10, <double X>, 20, <double Y> */
	static inline const int GC_PLimMin_X = 10;
	static inline const int GC_PLimMin_Y = 20;

	/* Governs the generation of linetype patterns around the vertices of a 2D polyline
	   - 9, $PLINEGEN, 70, <integer> */
	static inline const int GC_PLineGen = 70;
	...
	static inline const int GC_PLineWid = 40;
	...
	static inline const int GC_PStyleMode = 290;
	...
	static inline const int GC_PSVPScale = 40;
	//0 = Scaled to fit
	...
	/* Name of the UCS that defines the origin and orientation of orthographic UCS settings (paper space only)
	   - 9, $PUCSBASE, 2, <string> */
	static inline const int GC_PUCSBase = 2;

	/* Current paper space UCS name - 9, $PUCSNAME, 2, <string> */
	static inline const int GC_PUCSName = 2;

	/* Current paper space UCS origin - 9, $PUCSORG, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_PUCSOrg_X = 10;
	static inline const int GC_PUCSOrg_Y = 20;
	static inline const int GC_PUCSOrg_Z = 30;
	...
	static inline const int GC_PUCSOrgBack_X = 10;
	static inline const int GC_PUCSOrgBack_Y = 20;
	static inline const int GC_PUCSOrgBack_Z = 30;
	...
	static inline const int GC_PUCSOrgBottom_X = 10;
	static inline const int GC_PUCSOrgBottom_Y = 20;
	static inline const int GC_PUCSOrgBottom_Z = 30;
	...
	static inline const int GC_PUCSOrgFront_X = 10;
	static inline const int GC_PUCSOrgFront_Y = 20;
	static inline const int GC_PUCSOrgFront_Z = 30;
	...
	static inline const int GC_PUCSOrgLeft_X = 10;
	static inline const int GC_PUCSOrgLeft_Y = 20;
	static inline const int GC_PUCSOrgLeft_Z = 30;
	...
	static inline const int GC_PUCSOrgRight_X = 10;
	static inline const int GC_PUCSOrgRight_Y = 20;
	static inline const int GC_PUCSOrgRight_Z = 30;
	...
	static inline const int GC_PUCSOrgTop_X = 10;
	static inline const int GC_PUCSOrgTop_Y = 20;
	static inline const int GC_PUCSOrgTop_Z = 30;
	...
	static inline const int GC_PUCSOrthoRef = 2;

	/* Orthographic view type of paper space UCS - 9, $PUCSORTHOVIEW, 70, <integer> */
	static inline const int GC_PUCSorthoView = 70;
	...
	static inline const int GC_PUCSXDir_X = 10;
	static inline const int GC_PUCSXDir_Y = 20;
	static inline const int GC_PUCSXDir_Z = 30;

	/* Current paper space UCS Y axis - 9, $PUCSYDIR, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_PUCSYDir_X = 10;
	static inline const int GC_PUCSYDir_Y = 20;
	static inline const int GC_PUCSYDir_Z = 30;

	/* Quick Text mode on if nonzero - 9, $QTEXTMODE, 70, <integer> */
	static inline const int GC_QTextMode = 70;

	/* REGENAUTO mode on if nonzero - 9, $REGENMODE, 70, <integer> */
	static inline const int GC_RegenMode = 70;

	/* Controls the shading of edges - 9, $SHADEDGE, 70, <integer> */
	static inline const int GC_ShadeEdge = 70;
	...
	static inline const int GC_SortEnts = 280;
	//0 = Disables SORTENTS
	...
	static inline const int GC_UCSOrgBack_X = 10;
	static inline const int GC_UCSOrgBack_Y = 20;
	static inline const int GC_UCSOrgBack_Z = 30;
	...
	static inline const int GC_UCSOrgBottom_X = 10;
	static inline const int GC_UCSOrgBottom_Y = 20;
	static inline const int GC_UCSOrgBottom_Z = 30;
	...
	static inline const int GC_UCSOrgFront_X = 10;
	static inline const int GC_UCSOrgFront_Y = 20;
	static inline const int GC_UCSOrgFront_Z = 30;
	...
	static inline const int GC_UCSOrgLeft_X = 10;
	static inline const int GC_UCSOrgLeft_Y = 20;
	static inline const int GC_UCSOrgLeft_Z = 30;
	...
	static inline const int GC_UCSOrgRight_X = 10;
	static inline const int GC_UCSOrgRight_Y = 20;
	static inline const int GC_UCSOrgRight_Z = 30;
	...
	static inline const int GC_UCSOrgTop_X = 10;
	static inline const int GC_UCSOrgTop_Y = 20;
	static inline const int GC_UCSOrgTop_Z = 30;

	/* If model space UCS is orthographic (UCSORTHOVIEW not equal to 0), this is the name of 
	   the UCS that the orthographic UCS is relative to. If blank, UCS is relative to WORLD.
	   - 9, $UCSORTHOREF, 2, <string> */
	static inline const int GC_UCSOrthoRef = 2;

	/* Orthographic view type of model space UCS - 9, $UCSORTHOVIEW, 70, <integer> */
	static inline const int GC_UCSOrthoView = 70;
	//0 = UCS is not orthographic
	//1 = Top
	//2 = Bottom
	//3 = Front
	...
	static inline const int GC_UCSXDir_X = 10;
	static inline const int GC_UCSXDir_Y = 20;
	static inline const int GC_UCSXDir_Z = 30;

	/* Direction of the current UCS Y axis (in WCS) - 9, $UCSYDIR, 10, <double X>, 20, <double Y>, 30, <double Z> */
	static inline const int GC_UCSYDir_X = 10;
	static inline const int GC_UCSYDir_Y = 20;
	static inline const int GC_UCSYDir_Z = 30;

	/* Low bit set = Display fractions, feet-and-inches, and surveyors angles in input format
	   - 9, $UNITMODE, 70, <integer> */
	static inline const int GC_UnitMode = 70;

	/* Five integer variables intended for use by third-party developers - 9, $USERIx, 70, <integer> */
	static inline const int GC_UserI1 = 70;
	static inline const int GC_UserI2 = 70;
	static inline const int GC_UserI3 = 70;
	static inline const int GC_UserI4 = 70;
	static inline const int GC_UserI5 = 70;

	/* Five real variables intended for use by third-party developers - 9, $USERRx, 40, <double> */
	static inline const int GC_UserR1 = 40;
	static inline const int GC_UserR2 = 40;
	static inline const int GC_UserR3 = 40;
	static inline const int GC_UserR4 = 40;
	static inline const int GC_UserR5 = 40;

	/* Controls the user timer for the drawing - 9, $USRTIMER, 70, <integer> */
	static inline const int GC_UsrTimer = 70;
	//0 = Timer off
	//1 = Timer on

	/* Uniquely identifies a particular version of a drawing. Updated when the drawing is modified.
	   - 9, $VERSIONGUID, 2, <string> */
	static inline const int GC_VersionGUID = 2;

	/* Controls the properties of xref-dependent layers - 9, $VISRETAIN, 70, <integer> */
	static inline const int GC_VisRetain = 70;
	...
	/* Controls whether the current drawing can be edited in-place when being referenced by another drawing
	   - 9, $XEDIT, 290, <boolean> */
	static inline const int GC_XEdit = 290;
